...
func Create(c *gophercloud.ServiceClient, opts CreateOptsBuilder, lId string) (r elb.JobResult) {
...
func Get(c *gophercloud.ServiceClient, lId string, backendId string) (r GetResult) {
	url := rootURL(c, lId)
...
func Delete(c *gophercloud.ServiceClient, lId string, opts DeleteOpts) (r elb.JobResult) {

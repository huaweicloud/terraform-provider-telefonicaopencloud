		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingSecGroupV2DataSourceID("data.telefornicaopencloud_networking_secgroup_v2.secgroup_1"),
					resource.TestCheckResourceAttr(
						"data.telefornicaopencloud_networking_secgroup_v2.secgroup_1", "name", "secgroup_1"),
				),
			},
		},
	})
...
data "telefornicaopencloud_networking_secgroup_v2" "secgroup_1" {
	name = "${telefornicaopencloud_networking_secgroup_v2.secgroup_1.name}"
}
...
data "telefornicaopencloud_networking_secgroup_v2" "secgroup_1" {
	secgroup_id = "${telefornicaopencloud_networking_secgroup_v2.secgroup_1.id}"
}
`, testAccOpenStackNetworkingSecGroupV2DataSource_group)

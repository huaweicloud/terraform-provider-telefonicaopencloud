		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesV2DataSourceID("data.telefornicaopencloud_images_image_v2.image_1"),
					resource.TestCheckResourceAttr(
						"data.telefornicaopencloud_images_image_v2.image_1", "name", "CirrOS-tf_1"),
					resource.TestCheckResourceAttr(
						"data.telefornicaopencloud_images_image_v2.image_1", "container_format", "bare"),
					resource.TestCheckResourceAttr(
						"data.telefornicaopencloud_images_image_v2.image_1", "disk_format", "qcow2"),
					resource.TestCheckResourceAttr(
						"data.telefornicaopencloud_images_image_v2.image_1", "min_disk_gb", "0"),
					resource.TestCheckResourceAttr(
						"data.telefornicaopencloud_images_image_v2.image_1", "min_ram_mb", "0"),
					resource.TestCheckResourceAttr(
						"data.telefornicaopencloud_images_image_v2.image_1", "protected", "false"),
					resource.TestCheckResourceAttr(
						"data.telefornicaopencloud_images_image_v2.image_1", "visibility", "private"),
				),
			},
		},
	})
...
resource "telefornicaopencloud_images_image_v2" "image_2" {
  name = "CirrOS-tf_2"
  container_format = "bare"
  disk_format = "qcow2"
  image_source_url = "http://download.cirros-cloud.net/0.3.5/cirros-0.3.5-x86_64-disk.img"
...
data "telefornicaopencloud_images_image_v2" "image_1" {
	most_recent = true
	name = "${telefornicaopencloud_images_image_v2.image_1.name}"
}

		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("telefornicaopencloud_images_image_v2.image_1", &image),
					resource.TestCheckResourceAttr(
						"telefornicaopencloud_images_image_v2.image_1", "name", "Rancher TerraformAccTest"),
					resource.TestCheckResourceAttr(
						"telefornicaopencloud_images_image_v2.image_1", "container_format", "bare"),
					resource.TestCheckResourceAttr(
						"telefornicaopencloud_images_image_v2.image_1", "disk_format", "qcow2"),
					resource.TestCheckResourceAttr(
						"telefornicaopencloud_images_image_v2.image_1", "schema", "/v2/schemas/image"),
					resource.TestCheckResourceAttr(
						"telefornicaopencloud_images_image_v2.image_1", "properties.foo", "bar"),
					resource.TestCheckResourceAttr(
						"telefornicaopencloud_images_image_v2.image_1", "properties.baz", "foo"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("telefornicaopencloud_images_image_v2.image_1", &image),
					resource.TestCheckResourceAttr(
						"telefornicaopencloud_images_image_v2.image_1", "name", "TerraformAccTest Rancher"),
				),
			},
		},
	})
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("telefornicaopencloud_images_image_v2.image_1", &image),
					testAccCheckImagesImageV2HasTag("telefornicaopencloud_images_image_v2.image_1", "foo"),
					testAccCheckImagesImageV2HasTag("telefornicaopencloud_images_image_v2.image_1", "bar"),
					testAccCheckImagesImageV2TagCount("telefornicaopencloud_images_image_v2.image_1", 2),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckImagesImageV2HasTag("telefornicaopencloud_images_image_v2.image_1", "foo"),
					testAccCheckImagesImageV2HasTag("telefornicaopencloud_images_image_v2.image_1", "bar"),
					testAccCheckImagesImageV2HasTag("telefornicaopencloud_images_image_v2.image_1", "baz"),
					testAccCheckImagesImageV2TagCount("telefornicaopencloud_images_image_v2.image_1", 3),
				),
			},
			resource.TestStep{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("telefornicaopencloud_images_image_v2.image_1", &image),
					resource.TestCheckResourceAttr(
						"telefornicaopencloud_images_image_v2.image_1", "visibility", "private"),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("telefornicaopencloud_images_image_v2.image_1", &image),
					resource.TestCheckResourceAttr(
						"telefornicaopencloud_images_image_v2.image_1", "visibility", "public"),
				),
			},
		},
	})
...
func testAccCheckImagesImageV2Destroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "telefornicaopencloud_images_image_v2" {
			continue
		}
...
var testAccImagesImageV2_basic = `
  resource "telefornicaopencloud_images_image_v2" "image_1" {

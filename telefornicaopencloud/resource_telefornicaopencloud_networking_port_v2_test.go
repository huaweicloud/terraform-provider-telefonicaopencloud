	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingV2SubnetExists("telefornicaopencloud_networking_subnet_v2.vrrp_subnet", &subnet),
					testAccCheckNetworkingV2NetworkExists("telefornicaopencloud_networking_network_v2.vrrp_network", &network),
					testAccCheckNetworkingV2PortExists("telefornicaopencloud_networking_port_v2.vrrp_port_1", &vrrp_port_1),
					testAccCheckNetworkingV2PortExists("telefornicaopencloud_networking_port_v2.vrrp_port_2", &vrrp_port_2),
					testAccCheckNetworkingV2PortExists("telefornicaopencloud_networking_port_v2.instance_port", &instance_port),
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"telefornicaopencloud_networking_port_v2.port_1", "all_fixed_ips.0", "192.168.199.23"),
					resource.TestCheckResourceAttr(
						"telefornicaopencloud_networking_port_v2.port_1", "all_fixed_ips.1", "192.168.199.24"),
				),
			},
		},
	})
...
func testAccCheckNetworkingV2PortDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "telefornicaopencloud_networking_port_v2" {
			continue
		}
...
resource "telefornicaopencloud_networking_network_v2" "vrrp_network" {
  name = "vrrp_network"
  admin_state_up = "true"
}

resource "telefornicaopencloud_networking_subnet_v2" "vrrp_subnet" {
  name = "vrrp_subnet"
  cidr = "10.0.0.0/24"
  ip_version = 4
  network_id = "${telefornicaopencloud_networking_network_v2.vrrp_network.id}"
...
resource "telefornicaopencloud_networking_router_v2" "vrrp_router" {
  name = "vrrp_router"
}

resource "telefornicaopencloud_networking_router_interface_v2" "vrrp_interface" {
  router_id = "${telefornicaopencloud_networking_router_v2.vrrp_router.id}"
  subnet_id = "${telefornicaopencloud_networking_subnet_v2.vrrp_subnet.id}"
}

resource "telefornicaopencloud_networking_port_v2" "vrrp_port_1" {
  name = "vrrp_port_1"
  admin_state_up = "true"
  network_id = "${telefornicaopencloud_networking_network_v2.vrrp_network.id}"
...
resource "telefornicaopencloud_networking_port_v2" "vrrp_port_2" {
  name = "vrrp_port_2"
  admin_state_up = "true"
  network_id = "${telefornicaopencloud_networking_network_v2.vrrp_network.id}"
...
resource "telefornicaopencloud_networking_port_v2" "instance_port" {
  name = "instance_port"
  admin_state_up = "true"
  network_id = "${telefornicaopencloud_networking_network_v2.vrrp_network.id}"

  allowed_address_pairs {
    ip_address = "${telefornicaopencloud_networking_port_v2.vrrp_port_1.fixed_ip.0.ip_address}"
    mac_address = "${telefornicaopencloud_networking_port_v2.vrrp_port_1.mac_address}"
  }

  allowed_address_pairs {
    ip_address = "${telefornicaopencloud_networking_port_v2.vrrp_port_2.fixed_ip.0.ip_address}"
    mac_address = "${telefornicaopencloud_networking_port_v2.vrrp_port_2.mac_address}"
  }
}
`
...
resource "telefornicaopencloud_networking_port_v2" "instance_port" {
  ...
  admin_state_up = "true"
  network_id = "${telefornicaopencloud_networking_network_v2.vrrp_network.id}"
  security_group_ids = ["${telefornicaopencloud_networking_secgroup_v2.secgroup_1.id}"]
...
resource "telefornicaopencloud_networking_port_v2" "port_1" {
  ...
  network_id = "${telefornicaopencloud_networking_network_v2.network_1.id}"
  security_group_ids = [
    "${telefornicaopencloud_networking_secgroup_v2.secgroup_1.id}",
    "${telefornicaopencloud_networking_secgroup_v2.secgroup_2.id}"
  ]
...
resource "telefornicaopencloud_networking_port_v2" "port_1" {
  ...
  admin_state_up = "true"
  network_id = "${telefornicaopencloud_networking_network_v2.network_1.id}"
  security_group_ids = ["${telefornicaopencloud_networking_secgroup_v2.secgroup_2.id}"]

...
page_title: "TelefonicaOpenCloud: telefonicaopencloud_s3_bucket"
sidebar_current: "docs-telefonicaopencloud-resource-s3-bucket"
description: |-
  Provides a S3 bucket resource.
---

# telefonicaopencloud\_s3\_bucket
...
resource "telefonicaopencloud_s3_bucket" "versioning_bucket" {
...
```
$ terraform import telefonicaopencloud_s3_bucket.bucket bucket-name
```

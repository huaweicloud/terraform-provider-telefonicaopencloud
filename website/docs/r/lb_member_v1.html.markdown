...
page_title: "TelefonicaOpenCloud: telefonicaopencloud_lb_member_v1"
sidebar_current: "docs-telefonicaopencloud-resource-lb-member-v1"
description: |-
  Manages a V1 load balancer member resource within TelefonicaOpenCloud.
---

# telefonicaopencloud\_lb\_member_v1
...
```
$ terraform import telefonicaopencloud_lb_member_v1.member_1 a7498676-4fe4-4243-a864-2eaaf18c73df
```

...
page_title: "TelefonicaOpenCloud: telefonicaopencloud_networking_floatingip_v2"
sidebar_current: "docs-telefonicaopencloud-resource-networking-floatingip-v2"
description: |-
  Manages a V2 floating IP resource within TelefonicaOpenCloud Neutron (networking).
---

# telefonicaopencloud\_networking\_floatingip_v2
...
```
$ terraform import telefonicaopencloud_networking_floatingip_v2.floatip_1 2c7f39f3-702b-48d1-940c-b50384177ee1
```

...
page_title: "TelefonicaOpenCloud: telefonicaopencloud_mrs_cluster_v1"
sidebar_current: "docs-telefonicaopencloud-resource-mrs-cluster-v1"
description: |-
  Manages resource cluster within TelefonicaOpenCloud MRS.
---

# telefonicaopencloud\_mrs\_cluster\_v1
...
resource "telefonicaopencloud_mrs_cluster_v1" "cluster1" {
  ...
  vpc = "terraform-provider-telefonicaopencloud-vpc"
  vpc_id = "51edfb75-f9f0-4bbc-b4dc-21466b93f60d"
  subnet_id = "1d7a8646-43ee-455a-a3ab-40da87a1304c"
  subnet_name = "terraform-provider-telefonicaopencloud-subnet"

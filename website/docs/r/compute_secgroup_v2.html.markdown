...
page_title: "TelefonicaOpenCloud: telefonicaopencloud_compute_secgroup_v2"
sidebar_current: "docs-telefonicaopencloud-resource-compute-secgroup-v2"
description: |-
  Manages a V2 security group resource within TelefonicaOpenCloud.
---

# telefonicaopencloud\_compute\_secgroup_v2
...
```
$ terraform import telefonicaopencloud_compute_secgroup_v2.my_secgroup 1bc30ee9-9d5b-4c30-bdd5-7f1e663f5edf
```

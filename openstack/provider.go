...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"openstack_elb_loadbalancer":                resourceELBLoadBalancer(),
			"openstack_elb_listener":                    resourceELBListener(),
			"openstack_elb_healthcheck":                 resourceELBHealthCheck(),
			"openstack_elb_backendecs":                  resourceELBBackendECS(),
			"openstack_elb_quota":                       resourceELBQuota(),
			"openstack_elb_certificate":                 resourceELBCertificate(),

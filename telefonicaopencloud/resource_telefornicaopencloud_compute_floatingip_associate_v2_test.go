		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckNetworkingV2FloatingIPExists("telefornicaopencloud_networking_floatingip_v2.fip_1", &fip),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2InstanceExists("telefornicaopencloud_compute_instance_v2.instance_1", &instance),
					testAccCheckNetworkingV2FloatingIPExists("telefornicaopencloud_networking_floatingip_v2.fip_1", &fip_1),
					testAccCheckNetworkingV2FloatingIPExists("telefornicaopencloud_networking_floatingip_v2.fip_2", &fip_2),
...
func testAccCheckComputeV2FloatingIPAssociateDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "telefornicaopencloud_compute_floatingip_associate_v2" {
			continue
		}
...
resource "telefornicaopencloud_networking_floatingip_v2" "fip_1" {
}

resource "telefornicaopencloud_compute_floatingip_associate_v2" "fip_1" {
  floating_ip = "${telefornicaopencloud_networking_floatingip_v2.fip_1.address}"
  instance_id = "${telefornicaopencloud_compute_instance_v2.instance_1.id}"
}
`
...
resource "telefornicaopencloud_compute_floatingip_associate_v2" "fip_1" {
  floating_ip = "${telefornicaopencloud_networking_floatingip_v2.fip_1.address}"
  instance_id = "${telefornicaopencloud_compute_instance_v2.instance_1.id}"
  fixed_ip = "${telefornicaopencloud_compute_instance_v2.instance_1.access_ip_v4}"
}
`
...
resource "telefornicaopencloud_compute_floatingip_associate_v2" "fip_1" {
  floating_ip = "${telefornicaopencloud_networking_floatingip_v2.fip_1.address}"
  instance_id = "${telefornicaopencloud_compute_instance_v2.instance_1.id}"
  fixed_ip = "${telefornicaopencloud_compute_instance_v2.instance_1.network.0.fixed_ip_v4}"
}
`, OS_NETWORK_ID)
...
resource "telefornicaopencloud_compute_floatingip_associate_v2" "fip_1" {
  floating_ip = "${telefornicaopencloud_networking_floatingip_v2.fip_1.address}"
  instance_id = "${telefornicaopencloud_compute_instance_v2.instance_1.id}"
  fixed_ip = "${telefornicaopencloud_compute_instance_v2.instance_1.network.1.fixed_ip_v4}"
}
`, OS_NETWORK_ID)
...
resource "telefornicaopencloud_networking_floatingip_v2" "fip_2" {
}
...
resource "telefornicaopencloud_compute_floatingip_associate_v2" "fip_1" {
  floating_ip = "${telefornicaopencloud_networking_floatingip_v2.fip_2.address}"
  instance_id = "${telefornicaopencloud_compute_instance_v2.instance_1.id}"
}
`

		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDNSZoneV2DataSourceID("data.telefornicaopencloud_dns_zone_v2.z1"),
					resource.TestCheckResourceAttr(
						"data.telefornicaopencloud_dns_zone_v2.z1", "name", zoneName),
					resource.TestCheckResourceAttr(
						"data.telefornicaopencloud_dns_zone_v2.z1", "type", "PRIMARY"),
					resource.TestCheckResourceAttr(
						"data.telefornicaopencloud_dns_zone_v2.z1", "ttl", "7200"),
				),
			},
		},
	})
...
resource "telefornicaopencloud_dns_zone_v2" "z1" {
  name = "%s"
...
%s
data "telefornicaopencloud_dns_zone_v2" "z1" {
	name = "${telefornicaopencloud_dns_zone_v2.z1.name}"
}

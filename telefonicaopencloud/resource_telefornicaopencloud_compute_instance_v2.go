	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"floating_ip": &schema.Schema{
				...
				Optional: true,
				ForceNew: false,
				Removed:  "Use the telefornicaopencloud_compute_floatingip_associate_v2 resource instead",
			},
			...
			"volume": &schema.Schema{
				Type:     schema.TypeSet,
				Optional: true,
				Removed:  "Use block_device or telefornicaopencloud_compute_volume_attach_v2 instead",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"id": &schema.Schema{
							Type:     schema.TypeString,

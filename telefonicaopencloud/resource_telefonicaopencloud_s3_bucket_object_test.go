	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check:  testAccCheckS3BucketObjectExists("telefonicaopencloud_s3_bucket_object.object", &obj),
			},
		},
	})
}
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketObjectExists("telefonicaopencloud_s3_bucket_object.object", &obj),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket_object.object", "content_type", "binary/octet-stream"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket_object.object", "website_redirect", "http://google.com"),
				),
			},
		},
	})
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketObjectExists("telefonicaopencloud_s3_bucket_object.object", &obj),
					resource.TestCheckResourceAttr("telefonicaopencloud_s3_bucket_object.object", "etag", "647d1d58e1011c743ec67d5e8af87b53"),
				),
			},
			resource.TestStep{
				PreConfig: func() {
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketObjectExists("telefonicaopencloud_s3_bucket_object.object", &obj),
					resource.TestCheckResourceAttr("telefonicaopencloud_s3_bucket_object.object", "etag", "1c7fd13df1515c2a13ad9eb068931f09"),
				),
			},
		},
	})
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketObjectExists("telefonicaopencloud_s3_bucket_object.object", &originalObj),
					resource.TestCheckResourceAttr("telefonicaopencloud_s3_bucket_object.object", "etag", "cee4407fa91906284e2a5e5e03e86b1b"),
				),
			},
			resource.TestStep{
				PreConfig: func() {
				...
				Config: testAccS3BucketObjectConfig_updatesWithVersioning(rInt, tmpFile.Name()),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketObjectExists("telefonicaopencloud_s3_bucket_object.object", &modifiedObj),
					resource.TestCheckResourceAttr("telefonicaopencloud_s3_bucket_object.object", "etag", "00b8c73b1b50e7cc932362c7225b8e29"),
...
func testAccCheckS3BucketObjectDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "telefonicaopencloud_s3_bucket_object" {
			continue
		}
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketObjectExists(
						"telefonicaopencloud_s3_bucket_object.object", &obj),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket_object.object",
						"acl",
						"private"),
...
func testAccS3BucketObjectConfig_withContentCharacteristics(randInt int, source string) string {
	return fmt.Sprintf(`
resource "telefonicaopencloud_s3_bucket" "object_bucket_2" {
	bucket = "tf-object-test-bucket-%d"
}

resource "telefonicaopencloud_s3_bucket_object" "object" {
	bucket = "${telefonicaopencloud_s3_bucket.object_bucket_2.bucket}"
	key = "test-key"
	source = "%s"
	content_language = "en"
	content_type = "binary/octet-stream"
...
func testAccS3BucketObjectConfig_updates(randInt int, source string) string {
	return fmt.Sprintf(`
resource "telefonicaopencloud_s3_bucket" "object_bucket_3" {
	bucket = "tf-object-test-bucket-%d"
}

resource "telefonicaopencloud_s3_bucket_object" "object" {
	bucket = "${telefonicaopencloud_s3_bucket.object_bucket_3.bucket}"
	key = "updateable-key"
	source = "%s"
	etag = "${md5(file("%s"))}"
}

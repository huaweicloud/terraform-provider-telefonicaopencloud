		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingSubnetV2DataSourceID("data.telefornicaopencloud_networking_subnet_v2.subnet_1"),
					resource.TestCheckResourceAttr(
						"data.telefornicaopencloud_networking_subnet_v2.subnet_1", "name", "subnet_1"),
				),
			},
		},
	})
...
data "telefornicaopencloud_networking_subnet_v2" "subnet_1" {
	name = "${telefornicaopencloud_networking_subnet_v2.subnet_1.name}"
}
...
data "telefornicaopencloud_networking_subnet_v2" "subnet_1" {
  gateway_ip = "${telefornicaopencloud_networking_subnet_v2.subnet_1.gateway_ip}"
}
`, testAccOpenStackNetworkingSubnetV2DataSource_subnet)

		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckS3BucketHasPolicy("telefonicaopencloud_s3_bucket.bucket", expectedPolicyText),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					testAccCheckS3BucketHasPolicy("telefonicaopencloud_s3_bucket.bucket", expectedPolicyText1),
				),
			},

			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					testAccCheckS3BucketHasPolicy("telefonicaopencloud_s3_bucket.bucket", expectedPolicyText2),
				),
			},
		},
	})
...
resource "telefonicaopencloud_s3_bucket_policy" "bucket" {
	bucket = "${telefonicaopencloud_s3_bucket.bucket.bucket}"
	policy =<<POLICY
{
	"Version": "2008-10-17",
	"Statement": [{

		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckKmsKeyV1DataSourceID("data.telefonicaopencloud_kms_key_v1.key1"),
					resource.TestCheckResourceAttr(
						"data.telefonicaopencloud_kms_key_v1.key1", "key_alias", keyAlias),
				),
			},
		},
	})
...
%s
data "telefonicaopencloud_kms_key_v1" "key1" {
  key_alias       = "${telefonicaopencloud_kms_key_v1.key1.key_alias}"

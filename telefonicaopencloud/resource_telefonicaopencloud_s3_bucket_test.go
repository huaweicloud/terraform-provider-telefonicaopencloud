		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "bucket_domain_name", testAccBucketDomainName(rInt)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.test"),
					resource.TestMatchResourceAttr(
						"telefonicaopencloud_s3_bucket.test", "bucket", regexp.MustCompile("^tf-test-")),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					resource.TestCheckResourceAttr("telefonicaopencloud_s3_bucket.bucket", "region", OS_REGION_NAME),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckS3BucketPolicy(
						"telefonicaopencloud_s3_bucket.bucket", testAccS3BucketPolicy(rInt)),
				),
			},
			{
				Config: testAccS3BucketConfig(rInt),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					testAccCheckS3BucketPolicy(
						"telefonicaopencloud_s3_bucket.bucket", ""),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "acl", "public-read"),
				),
			},
			{
				Config: postConfig,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "acl", "private"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckS3BucketWebsite(
						"telefonicaopencloud_s3_bucket.bucket", "index.html", "", "", ""),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "website_endpoint", testAccWebsiteEndpoint(rInt)),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					testAccCheckS3BucketWebsite(
						"telefonicaopencloud_s3_bucket.bucket", "index.html", "error.html", "", ""),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "website_endpoint", testAccWebsiteEndpoint(rInt)),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					testAccCheckS3BucketWebsite(
						"telefonicaopencloud_s3_bucket.bucket", "", "", "", "hashicorp.com"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "website_endpoint", testAccWebsiteEndpoint(rInt)),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					testAccCheckS3BucketWebsite(
						"telefonicaopencloud_s3_bucket.bucket", "", "", "https", "hashicorp.com"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "website_endpoint", testAccWebsiteEndpoint(rInt)),
				),
			},
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckS3BucketWebsite(
						"telefonicaopencloud_s3_bucket.bucket", "", "", "", ""),
					testAccCheckS3BucketWebsiteRoutingRules("telefonicaopencloud_s3_bucket.bucket", nil),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "website_endpoint", ""),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					testAccCheckS3DestroyBucket("telefonicaopencloud_s3_bucket.bucket"),
				),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					testAccCheckS3BucketVersioning(
						"telefonicaopencloud_s3_bucket.bucket", s3.BucketVersioningStatusEnabled),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					testAccCheckS3BucketVersioning(
						"telefonicaopencloud_s3_bucket.bucket", s3.BucketVersioningStatusSuspended),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					updateBucketCors("telefonicaopencloud_s3_bucket.bucket"),
				),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckS3BucketLogging(
						"telefonicaopencloud_s3_bucket.bucket", "telefonicaopencloud_s3_bucket.log_bucket", "log/"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.id", "id1"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.prefix", "path1/"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.expiration.2613713285.days", "365"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.expiration.2613713285.date", ""),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.expiration.2613713285.expired_object_delete_marker", "false"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.1.id", "id2"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.1.prefix", "path2/"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.1.expiration.2855832418.date", "2016-01-12"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.1.expiration.2855832418.days", "0"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.1.expiration.2855832418.expired_object_delete_marker", "false"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.2.id", "id3"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.2.prefix", "path3/"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.3.id", "id4"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.3.prefix", "path4/"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.prefix", "path1/"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.enabled", "true"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.noncurrent_version_expiration.80908210.days", "365"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.1.id", "id2"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.1.prefix", "path2/"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.1.enabled", "false"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.1.noncurrent_version_expiration.80908210.days", "365"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.2.id", "id3"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.2.prefix", "path3/"),
...
func testAccAWSS3MultiBucketConfigWithTags(randInt int) string {
	t := template.Must(template.New("t1").
		Parse(`
resource "telefonicaopencloud_s3_bucket" "bucket1" {
...
resource "telefonicaopencloud_s3_bucket" "bucket2" {
...
resource "telefonicaopencloud_s3_bucket" "bucket3" {
...
resource "telefonicaopencloud_s3_bucket" "bucket4" {
...
resource "telefonicaopencloud_s3_bucket" "bucket5" {
...
resource "telefonicaopencloud_s3_bucket" "bucket6" {
...
resource "telefonicaopencloud_s3_bucket" "bucket" {
	provider = "telefonicaopencloud.reg1"
	bucket = "tf-test-bucket-%d"
	region = "%s"
}
...
func testAccS3BucketConfigWithLogging(randInt int) string {
	return fmt.Sprintf(`
resource "telefonicaopencloud_s3_bucket" "log_bucket" {
...
resource "telefonicaopencloud_s3_bucket" "bucket" {
	...
	acl = "private"
	logging {
		target_bucket = "${telefonicaopencloud_s3_bucket.log_bucket.id}"
		target_prefix = "log/"
	}
}
`, randInt, randInt)
...
resource "telefonicaopencloud_s3_bucket" "test" {
